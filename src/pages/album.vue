                    ...
                    <el-tab-pane :label="'评论('+(getAlbum.info.commentCount)+')'" name="second" class="pinglun">
                        ...
                        <div class="replay">
                            ...
                            <ul>
                                <li class="clearfloat" v-for='hot in getHotCommentPlaylist' :key="hot.id">
                                    ...
                                    <div class="fl replayInfo">
                                        ...
                                        <p class="time clearfloat">
                                            ...
                                            <span class="fr">
                                                <i>
                                                    <svg t="1630312398155" class="icon" viewBox="0 0 1024 1024"
                                                        version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="3866"
                                                        ...
                                                        <path
                                                            ...
                                                            p-id="3867" fill="#bfbfbf"></path>
                                                    </svg>
                                                </i>
                                            </span>
                                            <span class="fr dianzan">
                                                <i>
                                                    <svg t="1630312360725" class="icon" viewBox="0 0 1024 1024"
                                                        version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="2293"
                                                        width="200" height="200">
                                                        <path
                                                            ...
                                                            fill="#bfbfbf" p-id="2294"></path>
                                                    </svg>
                                                </i>
                                            </span>
                                            <span class="fr dianzan">
                                                <i>
                                                    <svg t="1630312308571" class="icon" viewBox="0 0 1024 1024"
                                                        version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="1260"
                                                        width="200" height="200">
                                                        <path
                                ...
                                <p class="moreCont" v-if="getHotCommentPlaylist">更多精彩评论></p>
                            </ul>
                        </div>
                        <div class="replay">
