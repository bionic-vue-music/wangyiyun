    ...
    <div class="myPlayer">
        ...
        <ul class="songInfo" >
            <li>
                ...
                <span v-if="getSongInfo.title" title="喜欢" >
                    <i>
                       <svg t="1629803789893" class="icon" viewBox="0 0 1170 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="2375" width="200" height="200"><path d="M999.511 150.794c-116.51-114.693-302.193-118.779-423.629-9.313-121.436-109.47-307.128-105.385-423.634 9.313-118.932 117.366-120.202 308.92-2.836 427.858 0.942 0.952 1.89 1.9 2.841 2.842l354.898 351.682c37.294 37.955 98.304 38.498 136.259 1.204l1.203-1.204 354.898-351.365c119.02-117.279 120.438-308.833 3.16-427.853-1.045-1.065-2.1-2.12-3.16-3.164zM953.58 536.202L598.682 887.89a32.118 32.118 0 0 1-45.42 0.184l-0.19-0.184-355.215-351.688c-93.921-92.708-94.91-243.998-2.201-337.92 0.727-0.737 1.464-1.47 2.201-2.201 92.442-90.015 239.012-92.411 334.341-5.458l43.68 37.575 43.36-37.575c95.75-86.508 242.33-83.415 334.342 7.065 93.48 93.159 93.742 244.455 0.588 337.93-0.2 0.19-0.389 0.39-0.588 0.584z" fill="#cdcdcd" p-id="2376"></path><path d="M749.972 267.305a16.056 16.056 0 0 0 16.057 16.056c57.651 0 104.386 46.736 104.386 104.382a16.056 16.056 0 0 0 32.118 0c0-75.387-61.117-136.5-136.5-136.5a16.061 16.061 0 0 0-16.06 16.062z" fill="#cdcdcd" p-id="2377"></path></svg>
                    </i>
                </span>
            </li>
            <li>
        ...
        <ul class="controll">
            <li>
                <svg t="1629648973567" class="icon" viewBox="0 0 1024 1024" version="1.1"
                    xmlns="http://www.w3.org/2000/svg" p-id="17179" width="200" height="200">
                    <path
                        ...
                        p-id="17180" fill="#ffffff"></path>
                </svg>
            </li>
            <li>
                <svg t="1629649428625" class="icon" viewBox="0 0 1024 1024" version="1.1"
                    xmlns="http://www.w3.org/2000/svg" p-id="22049" width="200" height="200">
                    <path
                        d="M712.6 212.4c64.7-41 117.3-14.4 117.3 59.6v478.8c0 73.9-52.5 100.6-117.3 59.6L357.7 585.8c-64.8-41-64.8-107.6 0-148.7l354.9-224.7z"
                        p-id="22050" fill="#ffffff"></path>
                    <path
                        d="M263.4 831.7h-9.8c-31.2 0-56.7-25.5-56.7-56.7V249.8c0-31.2 25.5-56.7 56.7-56.7h9.8c31.2 0 56.7 25.5 56.7 56.7V775c0 31.2-25.5 56.7-56.7 56.7z"
                        p-id="22051" fill="#ffffff"></path>
                </svg>
            </li>
            <li @click="on_off">
                <svg v-if=false t="1629649053272" class="icon" viewBox="0 0 1024 1024" version="1.1"
                    xmlns="http://www.w3.org/2000/svg" p-id="18914" width="200" height="200">
                    <path
        ...
        <div class="zzb1" title="展开音乐详情页">
            <i>
                <svg t="1629650442146" class="icon" viewBox="0 0 1024 1024" version="1.1"
                    xmlns="http://www.w3.org/2000/svg" p-id="22889" width="200" height="200">
                    <path
                        d="M512.133 399.517l-292.16 292.155c-12.27 12.28-32.186 12.28-44.457 0-12.28099999-12.27-12.281-32.186 0-44.457l314.388-314.388c12.27-12.28 32.186-12.28 44.457 0l314.387 314.388c6.14 6.136 9.211 14.183 9.211 22.228s-3.071 16.092-9.211 22.228c-12.27 12.28-32.186 12.28-44.457 0l-292.159-292.155z"
                        p-id="22890" fill="#cdcdcd"></path>
                </svg>
            </i>
        </div>
    ...
    export default {
        ...
        data() {
            return {
                Drawer:false,
                showLrc: true,
                noLrcTip: "[00:00.00]抱歉,当前音乐为纯音乐或暂无歌词...(＃°Д°)",
            }
        },
        computed: {
            ...mapGetters('playerModule', ['getSongInfo', 'getIsPlay','getDrawer'])
        },
        methods: {
            ...mapMutations('playerModule', ['setIsPlay','setDrawer']),
            // showDrawer(){
